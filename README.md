...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `Nevish-302`, `SeenIt`, `twitter_handle`, `shiven-upadhyay-9834bb100`, `email`, `shiven302_client`, `SeenIt`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/Nevish-302/SeenIt.git
   ```
...
Your Name - [@twitter_handle](https://twitter.com/twitter_handle) - shiven302@gmail.com
